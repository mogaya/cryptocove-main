	...
	return (
		<main className="mx-auto flex-grow w-full">
			<div className="flex flex-col justify-center items-center pt-32 pb-16 bg-primary">
				<h1 className="font-bold text-4xl md:text-5xl leading-tight text-center mb-6">Instant Settlement</h1>
				<div className="flex flex-col gap-8 w-[340px] md:w-[460px] bg-primary2 p-8 rounded-2xl">
					<div className="flex text-secondary justify-between items-center w-full rounded-2xl border-input bg-background px-4 py-3 text-sm">
						<span>Choose Settlement Account</span>
						<Sheet>
						...
						<div className="flex flex-col gap-2">
							...
							<div className="flex justify-between items-center">
								...
								<div className="flex flex-col gap-2 items-end">
									...
									<p className="text-secondary">USD 0.00</p>
								</div>
							</div>
						</div>
