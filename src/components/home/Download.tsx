			...
			<div className="mx-auto gap-8 max-w-7xl flex flex-col lg:flex-row justify-center items-center">
				<div className="flex flex-col">
					...
					<section className="flex flex-col gap-1 mb-8">
						<h3 className="font-bold text-xl text-center">Monitor & Approve On Mobile</h3>
						<p className="text-secondary text-center">
							Receive instant notifications, approve large settlements, and track payment flows from
							your phone.
						</p>
					</section>
