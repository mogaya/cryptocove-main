    ...
    >
      ...
      <div className="mx-auto max-w-7xl flex flex-col-reverse md:flex-row md:justify-between items-center z-20">
        <div id="hero-text" className="flex flex-col gap-8 z-40">
          ...
          <Dialog>
            <DialogTrigger className="font-bold text-xl primary-btn pl-6 pr-6 pt-4 pb-4 rounded-full self-start flex items-center gap-2 text-primary bg-gradient-to-r from-[#BAFF7A] to-[#4FFFC4] hover:brightness-120 active:scale-95 transition-all">
              Start Integrating
            </DialogTrigger>
          ...
          <div className="flex gap-20">
            <div className="flex flex-col">
              <h3 className="md:text-2xl font-bold">200+</h3>
              <p className="text-secondary">Settlement Countries</p>
            </div>
            <div className="flex flex-col">
              <h3 className="md:text-2xl font-bold">99.99%</h3>
              <p className="text-secondary">Gateway Uptime</p>
            </div>
            <div className="flex flex-col">
              <h3 className="md:text-2xl font-bold">$5B+</h3>
              <p className="text-secondary">Processed Volume</p>
            </div>
          </div>
        </div>
