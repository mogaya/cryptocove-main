...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="bg-gradient-to-t from-[#E9FFF7] via-[#F4FFF8] to-white flex pl-4 pr-4 pt-16 pb-16 justify-center"
    >
        ...
        >
          ...
          >
            ...
            <p className="text-black font-thin text-center">
              Sign up for Globpay, complete compliance checks, and invite your
              team.
            </p>
          </div>
          <Image
          ...
          >
            ...
            <p className="text-black font-thin text-center">
              Link wallets, custodians, or bank accounts to define settlement
              destinations.
            </p>
          </div>
          <Image
          ...
          >
            ...
            <p className="text-black font-thin text-center">
              Use our SDK or API to embed Globpay checkout, then simulate
              payments in sandbox.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-black font-thin text-center">
              Go live with instant crypto payments, automatic conversions, and
              real-time reporting.
            </p>
          </div>
        </div>
