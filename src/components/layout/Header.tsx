    ...
    >
      <section className="max-w-[1920px] text-secondary2 flex justify-between pt-4 pb-4 pl-6 pr-6 items-center mx-auto">
        ...
        <div id="header-right" className="flex items-center gap-8 lg:gap-12">
          ...
          <Dialog>
            <DialogTrigger className=" primary-btn pl-6 pr-6 pt-2 pb-2 rounded-full hidden lg:block text-primary bg-gradient-to-r from-[#BAFF7A] to-[#4FFFC4] hover:brightness-120 active:scale-95 transition-all">
              Start Integrating
            </DialogTrigger>
            <DialogContent className="bg-primary2 border-hidden p-10">
          ...
          <Sheet>
            <SheetTrigger className="cursor-pointer">
              <div
                ...
                style={{
                  maskImage: "url('/PNG/wallet-icon.png')",
                  maskSize: "32px 32px",
                  maskRepeat: "no-repeat",
                  maskPosition: "center",
                  WebkitMaskImage: "url('/PNG/wallet-icon.png')",
